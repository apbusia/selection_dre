...
def main(args):
    ...
    pre_filepath, post_filepath = None, None
    if pre_or_post == 'pre':
        pre_filepath = args.library_path
    else:
        post_filepath = args.library_path
...
if __name__ == "__main__":
    ...
    parser.add_argument("library_path", help="path to raw FASTQ file for library", type=str)
